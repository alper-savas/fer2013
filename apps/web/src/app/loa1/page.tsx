                        ...
                        <div className="space-y-6">
                            <div className="space-y-4">
                                ...
                                <div className="space-y-3 text-slate-300">
                                    <p>
                                        This configuration represents the lower boundary (Level of Automation 1), where the entire classification task is performed manually without any computational support. Your task is to:
                                    </p>
                                    <ul className="list-disc list-inside space-y-2 ml-4 text-slate-400">
                                        <li>Identify an outlier emotion among six presented images</li>
                                        <li>Perform all aspects of the classification task independently</li>
                                        <li>Make decisions without any computational or system assistance</li>
