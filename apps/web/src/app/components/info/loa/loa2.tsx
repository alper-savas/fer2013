                            ...
                            <div className="space-y-6">
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-3 text-slate-300">
                                        <p>
                                            In this configuration, you will perform all subtasks while receiving system-generated decision alternatives and
                                            <strong className="text-blue-400"> the system might not always be correct</strong>. Your role involves:
                                        </p>
                                        <p className="text-slate-400">
                                            Reviewing the system's suggested outlier emotions, analyzing the provided suggestions alongside your own observations,
                                            selecting the most appropriate outlier emotion based on your judgment, and maintaining full control over the final classification decision.
                                        </p>
