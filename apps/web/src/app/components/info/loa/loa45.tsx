                    ...
                    <div className="relative p-6 flex flex-col h-[500px]">
                            ...
                            <div className="space-y-6">
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-3 text-slate-300">
                                        <p>
                                            In this unified configuration (combining Levels 4 and 5), the system provides enhanced automation with preselection and
                                            <strong className="text-blue-400"> the system's recommendations might not always be correct</strong>. Your role involves:
                                        </p>
                                        <p className="text-slate-400">
                                            Reviewing both the preselected recommendation and the complete ranked list, choosing to either accept
                                            the system's suggestion (highest probability image) or select a different image, and making your final
                                            decision based on visual inspection and other considerations.
                                        </p>
                        ...
                        <div className="pt-4 flex flex-row justify-between items-center border-t border-slate-700/30">
                            ...
                            <Button
                                onClick={async () => {
                                    try {
                                        const trial = await createTrial({ automationLevel: AutomationLevel.LOA4_5 });
