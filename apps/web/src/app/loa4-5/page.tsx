                        ...
                        <div className="space-y-6">
                            <div className="space-y-4">
                                ...
                                <div className="space-y-3 text-slate-300">
                                    <p>
                                        In this unified configuration (combining Levels 4 and 5), the system provides enhanced automation with preselection. The process involves:
                                    </p>
                                    <ul className="list-disc list-inside space-y-2 ml-4 text-slate-400">
                                        <li>The system extracts facial features and identifies emotional expressions</li>
                                        <li>All images are ranked based on their probability of being an outlier</li>
                                        <li>The system preselects the top-ranked image as the recommended outlier (e.g., "Image 4: Happy")</li>
                                        <li>Review both the preselected recommendation and the complete ranked list</li>
                                        <li>Choose to either accept the system's suggestion (highest probability image) or select a different image</li>
                                        <li>Make your final decision based on visual inspection and other considerations</li>
                                    </ul>
                                    <p className="mt-4 text-slate-400">
                                        This configuration enhances automation through preprocessing, ranking, and preselection while maintaining
                                        human authority to validate or modify the outcome. Levels 4 and 5 are combined due to their minimal
                                        functional differences in the context of emotion recognition.
                                    </p>
                            ...
                            <div className="pt-4 flex flex-row justify-end">
                                <Button
                                    onClick={() => router.push("/loa4-5/trial")}
